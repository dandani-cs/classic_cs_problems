"""
Creating a weighted graph as subclass of graph class
"""
from typing import TypeVar, Generic, List, Tuple
from listing4_2 import Graph 
...
class WeightedGraph(Generic[V], Graph[V]):
	...
	def add_edges_by_indices(self, u, v, weight):
	...
	def add_edge_by_vertices(self, first, second, weight):
		...
		self.add_edges_by_indices(u, v, weight)

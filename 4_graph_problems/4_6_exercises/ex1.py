"""
graph class that can remove edges and vertices
"""
...
class Graph(Generic[V]):
	...
	def remove_vertex_at_index(self, u):
		self._vertices[u] = None
		v_list = []
		for edge in self._edges[u]:
			v_list.append(edge.v)
...
if __name__ == '__main__':
	...
	print(city_graph)
	city_graph.remove_edge_by_indices(0, 1)
	city_graph.remove_vertex_at_index(0)

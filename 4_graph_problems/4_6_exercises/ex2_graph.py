...
class Graph(Generic[V]):
	...
	def add_direct_edge(self, diedge):
		self._edges[diedge.u].append(diedge)


	def add_direct_edge_by_indeces(self, u, v):
		edge = DirectEdge(u, v)
		self.add_direct_edge(edge)


	def add_direct_edge_by_vertices(self, first, second):
		u = self.index_of(first)
		v = self.index_of(second)
		self.add_direct_edge_by_indeces(u, v)
...
if __name__ == '__main__':
	...
	city_graph.add_direct_edge_by_vertices("Seattle", "Washington")
	print(city_graph)

"""
Solving SEND + MORE = MONEY through genetic algorithm 
"""
...
if __name__ == '__main__':
	...
	ga = GeneticAlgorithm(initial_population=initial_population, threshold=1.0, max_generations=1000, mutation_chance=0.2, crossover_chance=0.7, selection_type=GeneticAlgorithm.SelectionType.ROULETTE)
	result = ga.run()
	print(result)
